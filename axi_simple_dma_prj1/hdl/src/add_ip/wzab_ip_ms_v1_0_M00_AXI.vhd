...
entity wzab_ip_ms_v1_0_M00_AXI is
  generic (
...
end wzab_ip_ms_v1_0_M00_AXI;

architecture implementation of wzab_ip_ms_v1_0_M00_AXI is
  ...
  begin
    count := 0;
    while depth < bit_depth loop        -- Works for up to 32 bit integers
      count := count + 1;
      depth := depth * 2;
    end loop;
    return(count);
